...
export const Alumni = () => {
  return (
    <>
    <Flex justifyContent={['space-between','space-between','space-around']} gap='30px' alignItems='center' py='70px' fontSize='24px' fontWeight='700' flexDir={['column','column','row']}>
